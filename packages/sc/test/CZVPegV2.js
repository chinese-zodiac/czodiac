...
describe("CZVPegV2", function() {
  ...
  describe("Repeg", function() {
    ...
    it("Should balance Ellipsis when over peg", async function() {
      ...
      console.log(formatEther(finalPrice));
    ...
    it("Should balance Ellipsis when under peg", async function() {
      ...
      await czusdSc.connect(deployer).mint(owner.address,parseEther("5000"));
      await czusdSc.approve(ellipsisCzusd3psPoolSc.address,parseEther("5000"));
      await ellipsisCzusd3psPoolSc.exchange_underlying(0,1,parseEther("5000"),0);
      const initialPrice = await ellipsisCzusd3psPoolSc.get_dy_underlying(1,0,parseEther("1"));
      console.log(formatEther(initialPrice));
