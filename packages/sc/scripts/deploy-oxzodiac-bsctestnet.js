...
const { uniswapRouterAddressBscTestnet, zeroAddress } = loadJsonFile.sync("./deployConfig.json");
...
async function main() {
  ...
  const cZodiacToken = await CZodiacToken.deploy(
    uniswapRouterAddressBscTestnet,//IUniswapV2Router02 _uniswapV2Router,
