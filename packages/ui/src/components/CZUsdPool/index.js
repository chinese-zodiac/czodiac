...
function CZUsdPool({
  ...
  return (<>
      ...
      <Button onClick={()=>{
        ...
        Stake {!!basisPoints ? (basisPoints/100).toFixed(2) : (100).toFixed(2)}% ({!!basisPoints ? weiToShortString(user.czfBal.mul(BigNumber.from(basisPoints)).div(BigNumber.from(10000)),2) : weiToShortString(user.czusdBal,2)} CZUSD)
      </Button>
      <br />
      ...
      <SimpleGrid columns="4" spacing="1" >
        <Text textAlign="right">Staked:</Text><Text textAlign="left">{weiToShortString(user.czfStaked,2)} CZUSD</Text>
        ...
        <Text textAlign="right">Wallet:</Text><Text textAlign="left">{weiToShortString(user.czfBal,2)} CZUSD</Text>
